...
// CompareSlicesOrdered does an ordered comparison of the elements of two slices.
// It returns true if all the elements of slice A match all elements of slice B.
...
// CompareSlicesUnordered does an unordered comparison of the elements of two slices.
// It returns true if all the elements of slice A match all elements of slice B.
